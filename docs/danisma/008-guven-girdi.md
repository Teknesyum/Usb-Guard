# Fable'a sorulan (008) — güven / zararsızlık ispatı

## Soru

USB-Guard tek bir .bat olarak dağıtılıyor ve içinde gzip+base64 gömülü bir PowerShell betiği var; bu, zararlı yazılım paketleyicileriyle birebir aynı desen. Kullanıcıya ve antivirüs motorlarına zararlı olmadığımızı nasıl ispat ederiz? Paketleme kaldırılsın mı, kaldırılırsa yerine ne konur, ve imza/şeffaflık için hangi somut adımlar hangi sırayla atılır? Bütçe gerektiren adımları ayrı işaretle.
